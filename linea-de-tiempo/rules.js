...
const ES = {
  ...
  howText: 'Las cartas muestran un hito, pero <b>no su año</b>. En tu turno eliges una carta y la ranura donde crees que va. Si aciertas, la carta se queda en la línea. Si fallas, se descarta y todos ven en qué año fue. Hay tres maneras de repartir. Con <b>todas a la vista</b> se despliega de una vez el doble de las cartas que hay que colocar para ganar y no entra ninguna más, así las más difíciles de situar van quedando para el final y cada turno se pone más complicado que el anterior. Con <b>pozo común</b> siempre hay 6 cartas a la vista y cada vez que sale una entra otra del mazo. Con <b>mano propia</b> cada uno juega con sus propias cartas y gana quien se queda sin ninguna. La ronda se termina siempre, y si más de uno llega a la meta gana el que respondió más rápido.',
...
const EN = {
  ...
  howText: 'Cards show a milestone but <b>not its year</b>. On your turn you pick a card and the slot where you think it belongs. Get it right and the card stays on the timeline. Get it wrong and it is discarded and everyone sees what year it was. There are three ways to deal. With <b>all on the table</b> you get twice as many cards as you need to place to win, laid out from the very first turn, and no card is ever added, so the hardest ones to place are left for the end and every turn gets harder than the one before. With a <b>shared pool</b> there are always 6 open cards and a new one comes in from the deck each time one leaves. With your <b>own hand</b> everyone plays their own cards and whoever runs out first wins. The round is always played out to the end, and if more than one player reaches the goal, the fastest one wins.',
