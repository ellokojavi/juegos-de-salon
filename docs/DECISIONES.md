...
**Consecuencias:** Queda en el canon C-1 y vale para cualquier juego nuevo. El teclado se ve menos "de fiesta", pero se lee. Falta aplicarlo a los años de Línea de Tiempo y a las coordenadas de Batalla Naval, que tienen el mismo problema con menos consecuencias.
