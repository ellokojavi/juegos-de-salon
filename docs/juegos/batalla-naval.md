...
- Lista de barcos a la derecha o debajo como fichas: 🚢 5 · 4 · 3 · 3 · 2. Se toca una ficha (queda seleccionada) y luego una casilla de la grilla: el barco se coloca desde esa casilla hacia la derecha (horizontal) o hacia abajo (vertical). La ficha también se puede **arrastrar** hasta el tablero y soltarla ahí (D-90).
