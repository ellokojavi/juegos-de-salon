...
const ES = {
  ...
  ui: {
    ...
    rules: [
      'Cada jugador recibe cinco dados y mira solo los suyos.',
      ...
      'El que sigue sube la apuesta: más cantidad, o la misma cantidad con pinta mayor, o bien dice "dudo".',
      'Al dudar se destapa todo y se cuenta. Si había tantos o más, pierde un dado quien dudó; si había menos, quien apostó.',
      '<b>Calzar</b> es decir que la cantidad es exacta: si aciertas recuperas un dado, si fallas pierdes uno. Para calzar debe haber tres o más jugadores.',
      'Quien se queda sin dados sale. Gana el último jugador con dados en su mano.',
    ],
...
const EN = {
  ...
  ui: {
    ...
    rules: [
      'Each player gets five dice and sees only their own.',
      'You bid how many dice of a face there are <b>on the whole table</b>: "four fives" is four dice showing a 5.',
      '<b>Aces are wild</b>: they count as whatever face was bid.',
      'The next player raises the bid: more dice, or the same count on a higher face, or else calls "liar".',
      ...
      '<b>Spot on</b> means the count is exact: get it right and you win a die back, get it wrong and you lose one. There have to be three or more players.',
      'Run out of dice and you\'re out. The last player with dice in hand wins.',
    ],
...
const PT = {
  ...
  ui: {
    ...
    rules: [
      'Cada jogador recebe cinco dados e vê só os seus.',
      'Aposta-se quantos dados de uma face tem <b>na mesa inteira</b>: "quatro cincos" são quatro dados com um 5.',
      'Os <b>ases são curinga</b>: contam como a face que foi apostada.',
      'O próximo aumenta a aposta: mais quantidade, ou a mesma com face maior, ou então fala "duvido".',
      'Na dúvida abre tudo e conta. Se tinha aquilo ou mais, perde um dado quem duvidou; se tinha menos, quem apostou.',
      '<b>Cravar</b> é dizer que a quantidade é exata: acertou, ganha um dado de volta; errou, perde um. Para cravar tem que haver três ou mais jogadores.',
      'Quem fica sem dados sai. Ganha o último jogador com dados na mão.',
    ],
    diceLeft: '{n} dados', diceLeftOne: '1 dado',
