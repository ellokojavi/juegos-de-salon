...
Recibes hitos sin fecha y los ubicas en el lugar correcto de una línea de tiempo común. Si aciertas, la carta se queda; si fallas, se descarta y robas otra. Gana quien se queda sin cartas: la ronda se juega completa, y si más de uno queda sin cartas gana el que respondió más rápido. Se elige la temática al empezar: **Historia** (98 hitos de la humanidad), **Música** (89, de Beethoven a TikTok), **Chile** (124, del terremoto del 60 al estallido, con Viña, la Teletón y las teleseries incluidas) y **Cultura pop** (110, cine, memes y videojuegos). Las cartas no se repiten entre partidas seguidas: cada celular recuerda las que ya mostró. Agregar una temática nueva es solo un archivo de datos.
