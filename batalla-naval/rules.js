...
const ES = {
  ...
  // batalla
  turnYou: '¡Te toca!', turnYouSub: 'Dispara a la flota de {name}', turnOther: 'Turno de {name}', turnOtherSub: 'Te está apuntando…',
  notYourTurn: 'Espera tu turno: ahora dispara {name}.', extraGo: '{result} Sigues disparando', waitingReply: 'Esperando la respuesta…',
  fire: '🎯 ¡Fuego!', enemyBoard: 'Flota de {name}', myBoard: 'Mi flota', showFleet: 'toca para ver mi flota', hideFleet: 'toca para ocultar',
  agua: 'Agua', tocado: '¡Tocado!', hundido: '¡Hundido!', sunkShip: 'Hundiste el {ship} de {name}', sunkMine: '¡Te hundieron el {ship}!',
  shotAt: '{name} disparó a {cell}',
...
const EN = {
  ...
  turnYou: 'Your turn!', turnYouSub: 'Fire at {name}\'s fleet', turnOther: '{name}\'s turn', turnOtherSub: 'They\'re aiming at you…',
  notYourTurn: 'Wait your turn: {name} is firing now.', extraGo: '{result} Fire again', waitingReply: 'Waiting for the reply…',
  fire: '🎯 Fire!', enemyBoard: '{name}\'s fleet', myBoard: 'My fleet', showFleet: 'tap to show my fleet', hideFleet: 'tap to hide',
  agua: 'Miss', tocado: 'Hit!', hundido: 'Sunk!', sunkShip: 'You sank {name}\'s {ship}', sunkMine: 'They sank your {ship}!',
  shotAt: '{name} fired at {cell}',
...
const PT = {
  ...
  // batalha
  turnYou: 'Sua vez!', turnYouSub: 'Atire na frota de {name}', turnOther: 'Vez de {name}', turnOtherSub: 'Estão mirando em você…',
  notYourTurn: 'Espere a sua vez: agora quem atira é {name}.', extraGo: '{result} Continue atirando', waitingReply: 'Esperando a resposta…',
  fire: '🎯 Fogo!', enemyBoard: 'Frota de {name}', myBoard: 'Minha frota', showFleet: 'toque para ver minha frota', hideFleet: 'toque para esconder',
  agua: 'Água', tocado: 'Acertou!', hundido: 'Afundou!', sunkShip: 'Você afundou o {ship} de {name}', sunkMine: 'Afundaram o seu {ship}!',
  shotAt: '{name} atirou em {cell}',
