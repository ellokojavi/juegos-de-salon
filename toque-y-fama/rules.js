...
const ES = {
  ...
  howText: 'Debes adivinar el número secreto de tu contendor antes de que adivine el tuyo. Por cada intento recibes pistas: <b>fama</b> es una cifra correcta en su lugar, <b>toque</b> es una cifra correcta en otro lugar. Gana quien llega a todas las famas. El celular cuenta solo, nadie hace trampa. Jugando solo, el celular elige el número secreto y tienes 10 intentos para adivinarlo.',
  ...
  modeSolo: '🧍 Jugar solo', modeSoloHint: 'El celular elige un número secreto de 4 cifras y tienes 10 intentos para adivinarlo. Mientras menos intentos uses, más puntos.',
  // setup
  ...
  blockHint: '💡 Mantén presionada una cifra para bloquearla si crees que no está en el número secreto. Repite para desbloquear.',
  ...
  soloHow: [
    'El celular elige un número secreto de 4 cifras distintas. Puede empezar con cero.',
    ...
    'Mantén presionada una cifra para bloquearla cuando sepas que no está. Tienes 10 intentos y el reloj corre mientras juegas.',
  ],
  scoringTitle: '🏅 Puntaje',
  soloScoring: 'Mientras menos intentos uses, más puntos: 100 si lo sacas al primero y 10 menos por cada intento más, hasta 10 si lo sacas al décimo. Si no lo sacas, son 0 puntos. Tu récord es tu mejor puntaje y, si empatas, cuenta el menor tiempo.',
...
const EN = {
  ...
  howText: 'You must guess your opponent\'s secret number before they guess yours. Every guess gets clues: a <b>bull</b> is a right digit in the right spot, a <b>cow</b> is a right digit in the wrong spot. First to score all bulls wins. The phone keeps score, so nobody can cheat. Playing alone, the phone picks the secret number and you have 10 guesses to crack it.',
  ...
  modeSolo: '🧍 Play alone', modeSoloHint: 'The phone picks a 4-digit secret number and you have 10 guesses to crack it. The fewer guesses you use, the more points you get.',
  ...
  blockHint: '💡 Long-press a digit to block it if you think it isn\'t in the secret number. Long-press again to unblock.',
  ...
  soloHow: [
    'The phone picks a secret number with 4 different digits. It can start with zero.',
    'Type a number with 4 different digits and tap Guess. Each guess tells you how many bulls it has (right digit in the right spot) and how many cows (right digit in the wrong spot).',
    'Long-press a digit to block it once you know it isn\'t there. You have 10 guesses and the clock runs while you play.',
  ],
  scoringTitle: '🏅 Scoring',
  soloScoring: 'The fewer guesses you use, the more points: 100 if you get it on the first try and 10 less for each extra guess, down to 10 on the tenth. If you don\'t crack it, you get 0 points. Your record is your best score, and on a tie the faster time counts.',
...
const PT = {
  ...
  howText: 'Você precisa descobrir o número secreto do adversário antes que ele descubra o seu. A cada tentativa você recebe pistas: <b>fama</b> é um algarismo certo no lugar certo, <b>toque</b> é um algarismo certo em outro lugar. Ganha quem chega a todas as famas. O celular conta sozinho, ninguém rouba. Jogando sozinho, o celular escolhe o número secreto e você tem 10 tentativas para descobrir.',
  ...
  modeSolo: '🧍 Jogar sozinho', modeSoloHint: 'O celular escolhe um número secreto de 4 algarismos e você tem 10 tentativas para descobrir. Quanto menos tentativas usar, mais pontos.',
  // configuração
  ...
  blockHint: '💡 Segure um algarismo para bloqueá-lo se você acha que ele não está no número secreto. Repita para desbloquear.',
  ...
  // jogar sozinho
  soloHow: [
    'O celular escolhe um número secreto de 4 algarismos diferentes. Ele pode começar com zero.',
    'Escreva um número de 4 algarismos diferentes e toque em Tentar. Cada tentativa mostra quantas famas ele tem (algarismo certo no lugar certo) e quantos toques (algarismo certo em outro lugar).',
    'Segure um algarismo para bloqueá-lo quando você souber que ele não está. Você tem 10 tentativas e o relógio corre enquanto você joga.',
  ],
  scoringTitle: '🏅 Pontuação',
  soloScoring: 'Quanto menos tentativas você usar, mais pontos: 100 se acertar na primeira e 10 a menos por cada tentativa a mais, até 10 se acertar na décima. Se não descobrir, são 0 pontos. Seu recorde é a sua melhor pontuação e, se empatar, vale o menor tempo.',
