...
const ES = {
  ...
  example: 'Ejemplo: secreto 1234, intento 1356 → 1 fama (el 1) y 1 toque (el 3).',
  ...
  // secret
  secretTitle: 'Tu número secreto', secretFor: 'Secreto de {name}', secretHint: '{n} cifras distintas. Que nadie mire.', secretHintNoZero: '{n} cifras distintas, sin cero al inicio. Que nadie mire.',
  confirm: 'Confirmar', hide: 'Tapar pantalla', tapToReveal: 'Toca para ver', secretSaved: 'Secreto guardado 🔒',
  ...
  inTries: 'en {n} intentos', secretsWere: 'Los secretos eran', verified: 'verificado ✅', notVerified: '⚠️ no coincide (¿trampa?)',
...
const EN = {
  ...
  example: 'Example: secret 1234, guess 1356 → 1 bull (the 1) and 1 cow (the 3).',
  ...
  secretTitle: 'Your secret number', secretFor: '{name}\'s secret', secretHint: '{n} different digits. No peeking.', secretHintNoZero: '{n} different digits, no leading zero. No peeking.',
  ...
  inTries: 'in {n} guesses', secretsWere: 'The secrets were', verified: 'verified ✅', notVerified: '⚠️ mismatch (cheating?)',
