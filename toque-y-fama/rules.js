...
const ES = {
  ...
  modeSolo: '🧍 Jugar solo', modeSoloHint: 'El celular elige un número secreto y tú lo adivinas en la menor cantidad de intentos para superar tu récord.',
  // setup
  ...
  soloTurn: 'Adivina el número secreto', soloStatus: 'Intento {n}', soloRecord: 'Récord: {n} {word}', soloBoard: 'Tus intentos',
  ...
  soloWin: '¡Lo adivinaste!', newRecord: '🏆 ¡Nuevo récord!', prevRecord: 'Tu récord: {n} {word}', soloSecretWas: 'El número secreto era',
...
const EN = {
  ...
  howText: 'You must guess your opponent\'s secret number before they guess yours. Every guess gets clues: a <b>bull</b> is a right digit in the right spot, a <b>cow</b> is a right digit in the wrong spot. First to score all bulls wins. The phone keeps score, so nobody can cheat. Playing alone, the phone picks the secret number and you try to crack it in as few guesses as you can.',
  ...
  modeSolo: '🧍 Play alone', modeSoloHint: 'The phone picks a secret number and you crack it in as few guesses as you can to beat your record.',
  ...
  soloTurn: 'Crack the secret number', soloStatus: 'Guess {n}', soloRecord: 'Record: {n} {word}', soloBoard: 'Your guesses',
  ...
  soloWin: 'You cracked it!', newRecord: '🏆 New record!', prevRecord: 'Your record: {n} {word}', soloSecretWas: 'The secret number was',
...
const PT = {
  ...
  modeSolo: '🧍 Jogar sozinho', modeSoloHint: 'O celular escolhe um número secreto e você tenta descobri-lo no menor número de tentativas para superar seu recorde.',
  // configuração
  ...
  soloTurn: 'Descubra o número secreto', soloStatus: 'Tentativa {n}', soloRecord: 'Recorde: {n} {word}', soloBoard: 'Suas tentativas',
  ...
  soloWin: 'Você descobriu!', newRecord: '🏆 Novo recorde!', prevRecord: 'Seu recorde: {n} {word}', soloSecretWas: 'O número secreto era',
