...
const ES = {
  ...
  tableTitle: 'Tabla',
  tableTitleProvisional: 'Tabla (provisoria)',
  ...
  imageSubtitleProvisional: 'Tabla de posiciones (provisoria) · día {d} de {n}',
  ...
  nameIs: 'Se llama «{copa}». El link no cambia.',
  nameEdit: 'Cambiar nombre',
  nameSave: 'Guardar',
  nameCancel: 'Cancelar',
  nameDone: 'Listo: la copa ahora se llama «{copa}».',
  youAdmin: 'tú, admin',
  ...
  shareTodayText: '🏆 *La Copa: {copa}* · Día {d} de {n}\n\n🎮 Hoy toca {juego}.\n⏰ Tienes hasta {hasta} para jugarlo.',
  ...
  errTerminada: 'La copa ya terminó: su nombre ya no se puede cambiar.',
