...
MODULES = [
    ...
    'assets/js/transport/local.js', 'assets/js/transport/firebase.js', 'assets/js/transport/cleanup.js', 'assets/js/transport/errors.js', 'assets/js/transport/ratelimit.js', 'assets/js/handoff.js', 'assets/js/session.js', 'assets/js/chat.js',
...
PAGES = { 'index.html': '', 'cuarto-rey/index.html': '../', 'toque-y-fama/index.html': '../', 'batalla-naval/index.html': '../', 'linea-de-tiempo/index.html': '../' }
